...
import net.timedoctor.core.model.lines.CyclesSampleLine;
import net.timedoctor.core.model.lines.EventSampleLine;
import net.timedoctor.core.model.lines.ISRSampleLine;
import net.timedoctor.core.model.lines.MemCyclesSampleLine;
import net.timedoctor.core.model.lines.NoteSampleLine;
import net.timedoctor.core.model.lines.PortSampleLine;
import net.timedoctor.core.model.lines.QueueSampleLine;
import net.timedoctor.core.model.lines.SemaphoreSampleLine;
import net.timedoctor.core.model.lines.TaskSampleLine;
import net.timedoctor.core.model.lines.ValueSampleLine;
